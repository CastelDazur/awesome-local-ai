...
Thanks for helping. Here's how.

## Adding a tool

1. Fork this repo
2. Add your entry to the appropriate category in README.md
3. Follow this format: `- [Name](URL) - One sentence description. Optional personal note.`
4. Submit a PR
...
If a tool doesn't fit existing categories, propose a new one in your PR description.
